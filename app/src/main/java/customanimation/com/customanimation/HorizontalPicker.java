...
public class HorizontalPicker extends View {
    ...
    public HorizontalPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            values = context.getResources().getStringArray(a.getResourceId(R.styleable.HorizontalPicker_values, R.styleable.HorizontalPicker_values));
...
//            postInvalidateOnAnimation(); // TODO
     ...
     * {@link customanimation.com.customanimation.HorizontalPicker#getInBoundsX(int)}
     *
